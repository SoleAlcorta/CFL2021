...
var RegistroAutomor = /** @class */ (function () {
    ...
    RegistroAutomor.prototype.addAuto = function () {
    ...
    RegistroAutomor.prototype.findAuto = function (patente) {
    ...
    RegistroAutomor.prototype.deleteAuto = function (patente) {
        var posicion = this.findAuto(patente);
        if (posicion != -1) {
            this.autos.splice(posicion, 1);
        }
    };
    RegistroAutomor.prototype.updateAuto = function (patenteVieja) {
    ...
    RegistroAutomor.prototype.mostrarAutos = function () {
        console.log(this.autos);
    };
    RegistroAutomor.prototype.cargarAutos = function () {
        var _this = this;
...
exports.default = RegistroAutomor;
